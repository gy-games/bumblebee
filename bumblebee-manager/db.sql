/*
SQLyog v10.2 
MySQL - 5.1.45-log : Database - db_bumblebee
*********************************************************************
*/
...
CREATE TABLE `operate_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1961 DEFAULT CHARSET=utf8 COMMENT='操作日志表';


insert  into `bumblebee_user`(`user_id`,`user_name`,`email`,`pwd`,`create_time`,`create_user`,`last_login_time`,`group_id`,`is_system`) values (1,'超级管理员','admin@gyyx.cn','E10ADC3949BA59ABBE56E057F20F883E','2017-06-28 17:30:40','超级管理员','2017-08-03 17:26:31',1,1);
