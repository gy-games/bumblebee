        ...
        <li>
            <div class="block">
                ...
                <div class="block_content">
                    ...
                    <p class="excerpt">
                        选择机器，然后输入Linux/Windows 系统命令,就可以远程执行并回复执行结果。<br/>
                    </p>
                </div>
            </div>
        </li>
        ...
        <li>
            <div class="block">
                ...
                <div class="block_content">
                    ...
                    <p class="excerpt">
                        这里的机器列表作为元数据，供操作人员进行操作，和查看Elves在该机器的在线状态.<br/>
                    </p>
                </div>
            </div>
        </li>
        <li>
            <div class="block">
                ...
                <div class="block_content">
                    ...
                    <p class="excerpt">
                        命令黑名单列表中的命令，在进行命令操作的时候都会被单节掉，避免出现不可预估的损失.<br/>
                    </p>
                </div>
            </div>
        </li>
        <li>
            <div class="block">
                ...
                <div class="block_content">
                    ...
                    <p class="excerpt">
                        主要功能点：用户管理、用户组管理、授权用户、授权用户组权限.<br/>
                    </p>
                </div>
            </div>
        </li>
